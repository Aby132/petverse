        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">PetVerse</h3>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your one-stop destination for all pet needs. Quality products, expert care, and endless love for your furry friends.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/veterinary" className="text-gray-300 hover:text-white transition-colors">
                  Veterinary Care
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/adoption" className="text-gray-300 hover:text-white transition-colors">
                  Pet Adoption
                </Link>
              </li>
            </ul>
